                ...
                return (
                  <Box className="dish_box" key={`${index}`}>
                    <Box
                      className="dish_img"
                      sx={{
                        backgroundImage: `url("/others/qovurma.jpg")`,
                      }}
                    >
            ...
            {Array.from(Array(4).keys()).map((ele, index) => {
              return (
                <Box className="review_box" key={index}>
                  ...
                  <span className="review_prof">Foydalanuchi</span>
                  <p className="review_desc">
                    Menga bu oshxonaning taomi juda yoqadi. Hammaga tavfsiya
                    qilaman!!
                  </p>
              ...
              return (
                <Box display={"flex"} flexDirection={"row"} key={index}>
                  ...
                  <div className="about_right_desc">
                    ...
                    <p>
                      Bizning oshpazlarimiz dunyo taniydigan oliygohda malaka
                      oshirib kelishgan
                    </p>
                  </div>
                </Box>
